...
func (handler *GetUserHandler) Handle(context context.Context, query GetUserQuery) (*userdto.UserDTO, error) {
...
func (handler *GetUserByEmailHandler) Handle(context context.Context, query GetUserByEmailQuery) (*userdto.UserDTO, error) {
