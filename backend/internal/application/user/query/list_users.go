...
func (handler *ListUsersHandler) Handle(context context.Context, query ListUsersQuery) (*userdto.PaginatedUsersDTO, error) {
	...
	return userdto.NewPaginatedUsersDTO(users, total, pagination), nil
}
